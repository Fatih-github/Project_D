...
public class AudioManager : MonoBehaviour
{
    ...
    public void PlaySound(string name)
    {
        ...
        {
            Debug.Log("Geluid by naam: " + name + " is niet gevonden!, Probleem bij AudioManager.PlaySound");
        }
    }
    ...
    public void StopSound(string name)
    {
        ...
        {
            Debug.Log("Geluid by naam: " + name + " is niet gevonden!, Probleem bij AudioManager.StopSound");
        }
    }
